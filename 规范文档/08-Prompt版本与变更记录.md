...
| 版本 | 日期 | 模块 | 变更说明 | 关联评测 |
|------|------|------|----------|----------|
| atlas_system_v5_enterprise | 2026-07-22 | SYSTEM_PROMPT | 企业制度优先、证据边界与工具泄露防护；与私有知识库工作流对齐 | 149 条门禁，持续回归 |
...
| 版本 | 日期 | 变更 | 改前 | 改后 | 结论 |
|------|------|------|------|------|------|
| atlas_system_v5_enterprise | 2026-07-22 | 企业制度优先、证据边界与工具泄露防护 | 149 条题库 | 最近一次全量回归需记录环境后归档 | 待持续验证 |
| atlas_system_v3 | 2026-07-21 | 制度推理三层结构+新示例；铁律+反注入；回答格式改为四段式 | 126/126 (v2未跑) | 已演进至 v5 | 历史版本 |
...
- [x] 代码侧已挂 `atlas_system_v5_enterprise`
